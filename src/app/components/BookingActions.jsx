  ...
  const handleCancel = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        router.refresh(); // page reload without full navigation
      } else {
  ...
  return (
    <div className='flex items-center gap-3 sm:flex-col sm:items-end'>
      <button
        ...
        className='cursor-pointer flex items-center gap-2 rounded-xl border border-red-300 px-4 py-2 text-sm font-medium text-red-500 transition hover:bg-red-50'
      >
        🗑 Cancel
      </button>
      <button
