...
const Banner = () => {
  return (
    <div className="bg-[url('/assets/Banner.png')] text-white  flex justify-between flex-col items-center  gap-5 h-150">
      <div className='container mx-auto max-w-7xl px-8 text-center flex justify-center flex-col items-center gap-3.5 flex-1'>
        ...
        <div className='flex gap-5'>
          ...
          <button className='uppercase px-5 py-3 bg-white/50 cursor-pointer'>
            <Link href='/add-destination'>View Destination</Link>
          </button>
        </div>
      </div>
